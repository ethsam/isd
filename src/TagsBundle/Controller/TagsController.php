...
namespace TagsBundle\Controller;

use TagsBundle\Entity\Tags;
...
class TagsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('TagsBundle:Tags')->findAll();
    ...
    {
        $tag = new Tag();
        $form = $this->createForm('TagsBundle\Form\TagsType', $tag);
    ...
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('TagsBundle\Form\TagsType', $tag);
